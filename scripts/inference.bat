...
set ckpt_steps=8500
set ckpt_dir=./out/AnchorWeave_pretrained
set ckpt_file=checkpoint-%ckpt_steps%.pt
set ckpt_path=%ckpt_dir%/%ckpt_file%
set video_root_dir=./data/%processed_data_name%
...
set pool_style=avg
set out_dir=%out_dir_base%/checkpoint-%ckpt_steps%_%processed_data_name%
rem ====================================
