...
:: ========== Configuration ==========
set MODEL_PATH=../pretrained/CogVideoX-5b-I2V
set video_root_dir=./data/Wan_sample_720p_outputs
set output_dir=./out/i2v_context_anchor_joint_attn_final_stage2
:: ====================================

set PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True
set CUDA_VISIBLE_DEVICES=0

:: Clear any stale distributed env vars from previous multi-GPU runs
set LOCAL_RANK=
set RANK=
set WORLD_SIZE=
set MASTER_ADDR=
...
python train_controlnet_i2v_use_latent.py ^
